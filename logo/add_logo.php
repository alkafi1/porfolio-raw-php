                ...
                <div class="col-lg-6 m-auto">
                    <div class="card">
                        <div class="card-header bg-info">
                            <h3 class="text-light">Add Logo</h3>
                        </div>
                        <div class="card-body">
                            <form action="add_logo_post.php" method="post" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-sm-5">
                                            ...
                                            <input type="file" name="logo" id="" class="form-control" value="" oninput="pic.src=window.URL.createObjectURL(this.files[0])">
                        ...
                        <div class="card-footer">
                            <h3>
                                <a href="view_logo.php"><button class="btn btn-warning float-left font-weight-bold mr-2"> View Logo</button></a>
                            </h3>
                        </div>
                    </div>
                </div>
