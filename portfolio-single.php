...
$select_portfolio = "SELECT * FROM pportfolios WHERE id='$id'";
$select_portfolio_res = mysqli_query($db_con, $select_portfolio);
$portfolio_assoc = mysqli_fetch_assoc($select_portfolio_res); 
...
//select user
$user_id = $portfolio_assoc['user_id'];
        ...
        <header>
            ...
            <div class="extra-info">
                ...
                <div class="side-info mb-30">
                    ...
                    <div class="contact-list mb-30">
                        <h4>Phone Number</h4>
                        <p><?='+880'.' '.$select_contact_info_affter_asso['number']?></p>
                    </div>
                    <div class="contact-list mb-30">
                        <h4>Email Address</h4>
                        ...
                        <div class="col-xl-9 col-lg-10">
                            <div class="single-blog-list">
                                <div class="blog-list-thumb mb-35">
                                    <img src="image/uploads/portfolio/<?=$portfolio_assoc['image']?>" alt="img">
                                </div>
                                <div class="blog-list-content blog-details-content portfolio-details-content">
                                    <h2><?=$portfolio_assoc['title']?></h2>
                                    <p><?=$portfolio_assoc['desp']?></p>
                                    ...
                                    <ul>
                                        <li>
                                            <div class="post-avatar-img">
                                                <img src="image/uploads/users/<?=$user_assoc['profile_photo']?>" alt="img">
                                            </div>
                                            <div class="post-avatar-content">
                                                <h5><?=$user_assoc['name'];?></h5>
