                ...
                <div class="col-lg-6 m-auto">
                    <div class="card">
                        <div class="card-header bg-info">
                            <h3 class="text-light">Add Contact Info</h3>
                        </div>
                        <div class="card-body">
                        ...
                        <div class="card-footer">
                            <h3>
                                <a href="view_contact_info.php"><button class="btn btn-warning float-left font-weight-bold mr-2"> View Contact Info</button></a>
                            </h3>
                        </div>
                    </div>
                </div>
...
<?php if(isset($_SESSION['contact_info_inserted'])) { ?>
     <script>
         Swal.fire({
            position: 'top-center',
            icon: 'success',
            title: '<?=$_SESSION['contact_info_inserted']?>',
            showConfirmButton: false,
            timer: 1500
            })
     </script>
<?php } unset($_SESSION['contact_info_inserted']); ?>
